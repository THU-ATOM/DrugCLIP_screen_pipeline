...
if __name__ == "__main__":
    ...
    parser.add_argument('--ncpu_pergrid',type=int,default=8,help='Number of cpus for each docking jobs')
    parser.add_argument('--max_process',type=int,default=128,help='Maximum number of docking task at the same time')
